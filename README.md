...
`--> In this project we will solve tasks about 'Binary Trees'`
...
-   And `func` is a pointer to a function to call for each node. The value in the node must be passe as a parameter to this function.
